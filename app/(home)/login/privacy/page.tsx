...
const PrivacyPage = () => {
  return (
    <div className="flex flex-col gap-10 py-8 px-6 max-w-[600px] mx-auto border-[1px] border-black rounded-md mt-5 md:mt-0">{`(주)오로라팩은 (이하 '회사'는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.
...
고객서비스담당 부서 : 인터넷 포장사업부
전화번호 : 070-7552-5670

이메일 : djdjdjk@hanmail.net
